...
const uint16_t CUBE_SPEED_50[] = {0x5303, 0xAF02, 0x2304, 0xFF04, 0x2606, 0x7101};
const uint16_t CUBE_SPEED_60[] = {0xC402, 0x3B02, 0x7103, 0x2904, 0x1E05, 0x3301};
...
const uint8_t SHIP_GRAVITY_lo[] = {0x42, 0xBE, 0x44, 0xBC, 0x2E, 0xD2, 0x2F, 0xD1};
